#CS
Thanks go out to Danylia, J Scott, and Montrell and their frieds
...
#Region CommonMaterial
Global Const $Array_Item_CommonMat = [ _
    921, 925, 929, 933, 934, 940, 946, _
    948, 953, 954, 955 _
]
Global Const $ITEM_ID_CommonMat_Bone = 921
Global Const $ITEM_ID_CommonMat_BoltCloth = 925
Global Const $ITEM_ID_CommonMat_GlitteringDust = 929
Global Const $ITEM_ID_CommonMat_Feather = 933
Global Const $ITEM_ID_CommonMat_PlantFiber = 934
Global Const $ITEM_ID_CommonMat_TannedHideSquare = 940
Global Const $ITEM_ID_CommonMat_WoodPlank = 946
Global Const $ITEM_ID_CommonMat_Iron = 948
Global Const $ITEM_ID_CommonMat_Scale = 953
Global Const $ITEM_ID_CommonMat_ChitinFragment = 954
Global Const $ITEM_ID_CommonMat_GraniteSlab = 955
#EndRegion CommonMaterial

#Region RareMaterial
Global Const $Array_Item_RareMat = [ _
    922, 923, 926, 927, 928, 930, 931, 932, _
    935, 936, 937, 938, 939, 941, 942, 943, _
    944, 945, 949, 950, 951, 952, 956, 6532, 6533 _
]
Global Const $ITEM_ID_RareMat_Charcoal = 922
Global Const $ITEM_ID_RareMat_MonstrousClaw = 923
Global Const $ITEM_ID_RareMat_BoltLinen = 926
Global Const $ITEM_ID_RareMat_BoltDamask = 927
Global Const $ITEM_ID_RareMat_BoltSilk = 928
Global Const $ITEM_ID_RareMat_GlobEctoplasm = 930
Global Const $ITEM_ID_RareMat_MonstrousEye = 931
Global Const $ITEM_ID_RareMat_MonstrousFang = 932
Global Const $ITEM_ID_RareMat_Diamond = 935
Global Const $ITEM_ID_RareMat_OnyxGemstone = 936
Global Const $ITEM_ID_RareMat_Ruby = 937
Global Const $ITEM_ID_RareMat_Sapphire = 938
Global Const $ITEM_ID_RareMat_TemperedGlassVial = 939
Global Const $ITEM_ID_RareMat_FurSquare = 941
Global Const $ITEM_ID_RareMat_LeatherSquare = 942
Global Const $ITEM_ID_RareMat_ElonianLeatherSquare = 943
Global Const $ITEM_ID_RareMat_VialInk = 944
Global Const $ITEM_ID_RareMat_ObsidianShard = 945
Global Const $ITEM_ID_RareMat_Steel = 949
Global Const $ITEM_ID_RareMat_DeldrimorSteel = 950
Global Const $ITEM_ID_RareMat_RollParchment = 951
Global Const $ITEM_ID_RareMat_RollVellum = 952
Global Const $ITEM_ID_RareMat_SpiritwoodPlank = 956
Global Const $ITEM_ID_RareMat_AmberChunk = 6532
Global Const $ITEM_ID_RareMat_JadeiteShard = 6533
#EndRegion RareMaterial
...
5656, 18345, 21491, 37765, 21833, 28433, 28434] ; Global array for pick-up every player cons
#EndRegion PCons
...
Global Const $Array_ID_PreSearing_Trophies = [ _
    422, 423, 424, 425, 426, 427, 428, 429, 430, _
    431, 432, 433, 2994 _
]
