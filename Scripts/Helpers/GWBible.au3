...
#Region Memory - Internal use only
...
Func DestroyItem($aItem)
	...
	Return SendPacket(0x10, $HEADER_ITEM_DESTROY, $lItemID)
EndFunc   ;==>DestroyItem
...
Func OfferItem($aItemID, $aQuantity = 1)
	...
	Return SendPacket(0xC, $HEADER_TRADE_OFFER_ITEM, $aItemID, $aQuantity)
EndFunc   ;==>OfferItem
...
Func MoveToX($aX, $aY, $aRandom = 50)
	...
	If CheckEnded() Then Return False
	Move($lDestX, $lDestY, 0)
